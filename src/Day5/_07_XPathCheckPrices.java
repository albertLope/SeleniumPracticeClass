...
public class _07_XPathCheckPrices extends BaseDriver {
    public static void main(String[] args) throws InterruptedException {
        ...
        if (result.equals("Login successful!")) {
            ...
            if(secondItemName.equals(nameOfSecondItem)) {
                System.out.println("Name compare success!");
            } else  {
                System.out.println("Name compare failure! Name: " + secondItemName + " not equal to " + nameOfSecondItem);
            }
            ...
            if(inventoryPriceOfSecondItem.equals(priceOfSecondItem)) {
                System.out.println("Price compare success!");
            } else  {
                System.out.println("Price compare failure! Price: " + inventoryPriceOfSecondItem + " not equal to " + priceOfSecondItem);
            }
        }
